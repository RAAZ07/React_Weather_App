    ...
    <div className="fullwidth-block">
        <div className="container">
            ...
            <div className="row">
                ...
                <div className="col-md-3 col-sm-6">
                    <div className="live-camera">
                        <figure className="live-camera-cover"><img src="images/live-camera-2.jpg" alt=""/></figure>
                ...
                <div className="col-md-3 col-sm-6">
                    <div className="live-camera">
                        <figure className="live-camera-cover"><img src="images/live-camera-3.jpg" alt=""/></figure>
                ...
                <div className="col-md-3 col-sm-6">
                    <div className="live-camera">
                        <figure className="live-camera-cover"><img src="images/live-camera-4.jpg" alt=""/></figure>
